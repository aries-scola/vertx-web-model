...
public class Link implements Comparable<Link> {
	...
	public Link setDisabled(boolean isDisabled) {
	...
	public Link setSelected(boolean isSelected) {
		this.isSelected = isSelected;
		return this;
	}

    public Link setSubmit(boolean isSubmit) {
        this.isSubmit = isSubmit;
        return this;
    }
	
	public Link setTooltip(String tooltip) {
