...
public abstract class BasePage<T extends BasePage<T>> {
    ...
    private Collection<String> javascripts = null;
	private Messages messages = null;
	private Collection<Link> navigationLinks = null;
	...
	public T addJavascripts(String... urls) {
    ...
    public T addNavigationLink(Link... links) {
	...
	public T addStylesheets(String...urls) {
		Objects.requireNonNull(urls);
	...
	public Collection<String> getJavascripts() {
		return javascripts!=null ? javascripts : Collections.emptyList();
	}
	...
	public Collection<Link> getNavigationLinks() {
        return navigationLinks!=null ? navigationLinks : Collections.emptyList();
	}
	
	public Collection<String> getStylesheets() {
		return stylesheets!=null ? stylesheets : Collections.emptyList();
	}
