...
public class CharsetAwareResourceControl extends ResourceBundle.Control {
	...
	public CharsetAwareResourceControl(Charset charset) {
	...
	public ResourceBundle newBundle(String baseName, Locale locale,
        ...
        if (format.equals("java.class")) {
            ...
            if (stream != null) {
                try {
                    bundle = getCharsetAwareBundle(stream, charset);
                } finally {
                    stream.close();
                }
            }
	...
	protected ResourceBundle getCharsetAwareBundle(InputStream inputStream, Charset charset) throws IOException {
	    return new PropertyResourceBundle(new InputStreamReader(inputStream, charset));
	}
